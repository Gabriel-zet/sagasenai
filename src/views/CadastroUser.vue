    ...
    <div class="wrapper Cadastrar-Form">
      ...
      <div class="sct login">
        <form method="post" @submit.prevent="enviarFormulario">
          ...
          <label for="nome"> Nome </label>
          <div id="Nome">
            <input class="Cad-Input" v-bind:style="{ backgroundImage: 'url(/Perfil.svg)' }" type="text" v-model="dadosDoFormulario.nome" />
          </div>
          ...
          <div class="select-container">
            <select class="Cad-Input" v-bind:style="{ backgroundImage: 'url(/Local.png)' }" id="instituto" name="instituto"
              v-model="dadosDoFormulario.instituto" required>
          ...
          <h4 class="text-center">
            Já tem uma conta?<span><router-link to="/login">Entrar</router-link></span>
          </h4>
        </form>
