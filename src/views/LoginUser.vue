      ...
      <div class="wrapper Entrar-Form">
        ...
        <div 
          ...
          <form 
              ...
              <h4 class="text-center">Não tem uma conta?<span><router-link to="/cadastrar">Criar Uma</router-link></span></h4>
  ...
  export default {
    ...
    methods: {
      fazerLogin() {
        ...
        axios.post('http://localhost:12345/login', dadosDoFormulario)
          .then(response => {
...
input[type="text"], input[type="email"], input[type="number"], input[type="password"], select {
    ...
    border-radius: 0;
    background: 15px center / 15px no-repeat var(--Magno-Finish); /* Estilo da imagem de fundo */
...
input[type="submit"]:active, input[type="submit"]:focus, input[type="submit"]:visited, input[type="submit"]:hover {
